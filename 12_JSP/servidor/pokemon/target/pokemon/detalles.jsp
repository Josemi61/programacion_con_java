      ...
      %>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><form action="cambiarTipo.jsp" method="post"><input type="hidden" name="idtipo" value=<%= "\"" + resultado.getString("id") + "\""%> > <input type="hidden" name="numpo" value=<%= "\"" + resultado.getString("numpo") + "\""%> ><button class="btn btn-info\">Editar</button></form></td>
            <td><form action="borrarTipo.jsp" method="post"><input type="hidden" name="idtipo" value=<%= "\"" + resultado.getString("id") + "\""%> ><button class="btn btn-info\">Borrar</button></form></td>
          </tr>
          <%
          }
          %>
