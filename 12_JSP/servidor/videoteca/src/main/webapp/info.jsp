...
<html lang="es">
  ...
  <body>
    ...
    <h1>Videoteca</h1>
      ...
      <div>
        <h2>Origen</h2>
        <p><b>Director: </b> <%= resultado.getString("director")%></p>
        <p><b>Duracion: </b> <%= resultado.getString("duracion")%></p>
        <p><b>Año:  </b> <%= resultado.getString("anio")%></p>
        <p><b>Género/s: </b> </p>
        <p><b>Argumento:</b></p>
        <p><%=resultado.getString("argumento") %></p>
      </div>
      <a href="http://localhost:8080/videoteca">Volver atras</a>
    </div>
    <% 
    conexion.close();
    %>
